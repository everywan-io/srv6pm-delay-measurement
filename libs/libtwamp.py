...
from scapy.all import IntField, BitField, BitEnumField, ByteField, Packet


# TODO integrare codice SRv6


class TWAMPSenderTestPacket(Packet):
    name ="TWAMPSenderTestPacket"
...
class TWAMPReflectorTestPacket(Packet):
    name ="TWAMPReflectorTestPacket"
    fields_desc=[IntField("SequenceNumber",0),
                 BitField("FirstPartTimestamp",0,32),
                 BitField("SecondPartTimestamp",0,32),
                 BitEnumField("S", 0, 1, {0: " no external synchronization",
