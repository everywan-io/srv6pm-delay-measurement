...
class STAMPSessionReflector:
    ...
    def __init__(self, stop_event=None):
        ...
        self.baseline_packet = libstamp.core.generate_stamp_test_reply_template(
            src_ip='12:1::1',
            dst_ip='f2::',
            dst_udp_port=42069,
            src_udp_port=862,
    ...
    def stamp_test_packet_received_raw(self, packet, ts):
        ...
        return libstamp.core.send_stamp_packet_raw(self.baseline_packet, 'f2::', self.reflector_socket.outs)
